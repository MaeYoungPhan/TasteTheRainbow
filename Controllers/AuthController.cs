...
using TasteTheRainbow.Models.DTOs;
using TasteTheRainbow.Data;

namespace TasteTheRainbow.Controllers;
...
{
    private TasteTheRainbowDbContext _dbContext;
    private UserManager<IdentityUser> _userManager;

    public AuthController(TasteTheRainbowDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
